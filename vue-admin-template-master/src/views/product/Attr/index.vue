<template>
    <div>
        ...
        <el-card shadow="always">
            ...
            <!-- 添加属性|修改属性的结构 -->
            <div v-show="!isShowTable">
                <el-form ref="form" :rules="rules" label-width="80px" :inline="true" size="normal" :model="attrInfo">
                ...
                <el-table border stripe style="width:100%;margin:20px 0px" :data="attrInfo.attrValueList">
                    <el-table-column type="index" prop="" label="序号" width="80" align="center">
                    </el-table-column>
